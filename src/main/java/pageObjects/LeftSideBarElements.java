...
public interface LeftSideBarElements {
    ...
    String CATEGORY_WOMEN_DRESS_PAGE = "//h2[normalize-space()='Women - Dress Products']";
    String CATEGORY_MEN_TSHIRTS_PAGE = "//h2[normalize-space()='Men - Tshirts Products']";
    ...
    String POLO_PRODUCTS_PAGE = "//h2[normalize-space()='Brand - Polo Products']";
    String MADAME_PRODUCTS_PAGE = "//h2[normalize-space()='Brand - Madame Products']";
}